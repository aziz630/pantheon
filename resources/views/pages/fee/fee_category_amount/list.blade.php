            ...
            <h3 class="card-label">
                {{
                    isset($trashed) && $trashed == true
                        ? "Trashed Fee Categories"
                        : "All Fee Categories Amount"
                }}
            </h3>
        </div>
    ...
    <div class="card-body">
        ...
        >
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $key+1 }}</td>
                    <td> {{ $amount['fee_cateogry']['category_name'] }}</td>
                    ...
                    <a href="{{ route('fee.amount.detail',$amount->fee_category_id) }}" class="btn btn-primary" >Details</a>
                    </td>
                </tr>
                @endforeach
