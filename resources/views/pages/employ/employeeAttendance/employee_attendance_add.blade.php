        ...
        <form method="post" action="{{ route('store.employee.attendance') }}">
            ...
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <div class="form-group">
                        <label>Attendance Date</label><span class="text-danger">*</span>
                        <input
                            type="text"
            ...
            <div class="row">
                ...
                >
                        ...
                        <tr>
                            <th class="text-center btn present_all" style="display: table-cell; background-color: #ccc; color:#000">Present</th>
                            <th class="text-center btn leave_all" style="display: table-cell; background-color: #ccc; color:#000" >Leave</th>
                            <th class="text-center btn absent_all" style="display: table-cell; background-color: #ccc; color:#000">Absent</th>
                        </tr> 
                        </thead>
                        <tbody>
