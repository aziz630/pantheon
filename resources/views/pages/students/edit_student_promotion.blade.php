...
<form
    class="form"
    method="post"
    action="{{ route('promote.student',$editData->student_id) }}"
    id="update_form"
        ...
        <div class="card-body p-5">
            ...
            <div class="row">
                <div class=" col-xxl-12">
                    ...
                    @include('pages.students.partials_promotion_Edit.personal_details')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class=" col-xxl-12">
                   ...
                   <h4 class="mb-10 font-weight-bold text-dark">
                    ...
                    @include('pages.students.partials_promotion_Edit.addresses')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class=" col-xxl-12">
                   ...
                   <h4 class="mb-10 font-weight-bold text-dark">
                    ...
                    @include('pages.students.partials_promotion_Edit.guardians')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class=" col-xxl-12">
                   ...
                   <h4 class="mb-10 font-weight-bold text-dark">
                    ...
                    @include('pages.students.partials_promotion_Edit.enrollment')
                </div>
            </div>
        </div>
    </div>
