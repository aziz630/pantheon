...
<div class="card card-custom gutter-b example example-compact">
    ...
    <form
        class="form"
        method="post"
        action="{{ route('update.other.cost', $editData->id) }}"
        id="enrollment_form"
                    ...
                    <div class=" col-xxl-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="controls">
                                        <img id="showImage" src="{{ (!empty($editData->image))? url('upload/cost_images/'.$editData->image):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;"> 
