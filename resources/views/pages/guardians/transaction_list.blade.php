...
<div class="card card-custom mb-7">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <a
                href="{{ route('family_account.deposit', [$transactions->id]) }}"
            ...
            <a
                href="{{ route('family_account.withdraw', [$transactions->id]) }}"
    ...
    <div class="card-body">
        ...
        >
            <thead>
                ...
                <tr>
                    <th>{{ $transactions->grd_name }}</th>
                    <th>{{ $transactions->grd_cnic_no }}</th>
                    <th>{{ $transactions->grd_mobile }}</th>
                    <th>{{ $transactions->account_balance }}</th>
                </tr>
            </thead>
        </table>
        <br />
        ...
        >
            ...
            <tbody>
                @php $totalTransactions =
                count($transactions->account_transaction); $i = 0; @endphp
                @foreach($transactions->account_transaction as $row)
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <a
                            href="{{ url('reverse_transaction/' . $row->id) }}"
